...
function Adminpage(props) {
    ...
    useEffect(() => {
        ...
        const postdata = async () => {
            const res = await axios.post('https://rent-house-backend.onrender.com/user/verifylogin', usertoken)
            try {
                
                if (res) {
                    const productdata = async () => {
                        const res = await axios.get('https://rent-house-backend.onrender.com/product/products')
                        try {
                            const { data } = res
                            setproduct(data)
                            setrecords(data)
    ...
    const deleteProduct = (id) => {
        axios.delete(`https://rent-house-backend.onrender.com/admin/deleteProduct/${id}`)
            .then((res) => {
