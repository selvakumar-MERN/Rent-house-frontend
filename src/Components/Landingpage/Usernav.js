...
function Usernav(props) {
    ...
    useEffect(() => {
        ...
        axios.post('https://rent-house-backend.onrender.com/user/cart',email)
            .then(res => {
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-dark navbar-static-top">
                <div className='container mt-2'>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown">
                       ...
                       <img className="img-profile rounded-circle" height={"25px"} width={"25px"} src="profile.png" alt='...'></img>
                   </a>
